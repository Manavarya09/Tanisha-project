...
export interface Question {
  ...
  text: string;
  category: string;
  pillar: 'organization' | 'data' | 'business' | 'infrastructure';
  options: Array<{
    value: number;
    label: string;
  }>;
...
const standardOptions = [
  { value: 1, label: 'Strongly Disagree / Not at all' },
  { value: 2, label: 'Disagree / Minimal' },
  { value: 3, label: 'Neutral / Moderate' },
  { value: 4, label: 'Agree / Significant' },
  { value: 5, label: 'Strongly Agree / Extensive' }
];

// Helper function to create a question
const createQuestion = (id: string, text: string, category: string, pillar: 'organization' | 'data' | 'business' | 'infrastructure'): Question => ({
  id,
  question: text,
  text,
  category,
...
export const assessmentQuestions: Question[] = [
  ...
  createQuestion('org_strategy_1', 'Does the organization have a long-term vision for AI adoption and integration into its business strategy?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_2', 'Is this AI strategy aligned with its business objectives?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_3', 'Does the strategy include a timeline with clear targets?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_4', 'Are senior leaders committed to and actively involved in driving AI adoption within the organization?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_5', 'Is there a designated AI champion or leadership team responsible for overseeing AI initiatives?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_6', 'Are there initiatives to monitor and track emerging trends in AI research, development, and applications to stay ahead of the curve?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_7', 'Is there alignment between the organization\'s culture and values and the goals and objectives of AI initiatives?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_8', 'Are employees across different levels of the organization aware of and aligned with the organization\'s AI strategy and objectives?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_9', 'Is there effective communication and collaboration between different departments or teams involved in AI initiatives?', 'Strategy and Leadership', 'organization'),
  createQuestion('org_strategy_10', 'Are there channels for sharing knowledge, updates, and insights across departments to foster cross-functional collaboration?', 'Strategy and Leadership', 'organization'),

  // Culture and Change Management (4 questions)
  createQuestion('org_culture_1', 'Is there a culture of innovation and experimentation that supports AI adoption within the organization?', 'Culture and Change Management', 'organization'),
  createQuestion('org_culture_2', 'Are employees receptive to new technologies and willing to adapt to changes brought by AI?', 'Culture and Change Management', 'organization'),
  createQuestion('org_culture_3', 'Is there a change management plan in place to address potential resistance to AI adoption and facilitate organizational change?', 'Culture and Change Management', 'organization'),
  createQuestion('org_culture_4', 'How confident are employees in using AI technologies without fear of job displacement?', 'Culture and Change Management', 'organization'),

  // Financial Support (3 questions)
  createQuestion('org_financial_1', 'Are there budgeting processes and financial controls in place to track and manage AI-related expenditures?', 'Financial Support', 'organization'),
  createQuestion('org_financial_2', 'Does the organization have a funding model (e.g., internal budgets, grants, investors) to sustain AI initiatives over 3-5 years?', 'Financial Support', 'organization'),
  createQuestion('org_financial_3', 'Is there a booked budget for the current year for AI investments?', 'Financial Support', 'organization'),

  // Talent and Skills (4 questions)
  createQuestion('org_talent_1', 'Does the organization have a sufficient pool of talent with expertise in AI and data science?', 'Talent and Skills', 'organization'),
  createQuestion('org_talent_2', 'Are employees equipped with the necessary skills and knowledge to work with AI technologies?', 'Talent and Skills', 'organization'),
  createQuestion('org_talent_3', 'Is there a development plan in place for upskilling or hiring additional talent to support AI initiatives?', 'Talent and Skills', 'organization'),
  createQuestion('org_talent_4', 'Are there initiatives in place to attract top AI talent, such as recruitment programs, partnerships with educational institutions, or professional development opportunities?', 'Talent and Skills', 'organization'),

  // Training and Development (4 questions)
  createQuestion('org_training_1', 'Is the organization committed to continuous learning and improvement in AI adoption through ongoing assessment, feedback, and adaptation?', 'Training and Development', 'organization'),
  createQuestion('org_training_2', 'Are there resources, workshops, or online courses available to help employees understand AI concepts, applications, and implications for their roles?', 'Training and Development', 'organization'),
  createQuestion('org_training_3', 'Are there forums or platforms for sharing lessons learned and best practices across teams and departments?', 'Training and Development', 'organization'),
  createQuestion('org_training_4', 'Does the organization provide training to integrate AI tools into daily workflows for non-technical employees?', 'Training and Development', 'organization'),

  // Legal, Governance, Regulatory and Ethical Considerations (4 questions)
  createQuestion('org_legal_1', 'Does the organization have processes in place to ensure responsible and ethical AI deployment?', 'Legal, Governance, Regulatory and Ethical Considerations', 'organization'),
  createQuestion('org_legal_2', 'Does the organization have an ethics committee or oversight body responsible for reviewing and guiding AI projects?', 'Legal, Governance, Regulatory and Ethical Considerations', 'organization'),
  createQuestion('org_legal_3', 'Are there mechanisms for monitoring and addressing potential risks and biases associated with AI algorithms?', 'Legal, Governance, Regulatory and Ethical Considerations', 'organization'),
  createQuestion('org_legal_4', 'Are there mechanisms for ensuring compliance with relevant laws and regulations throughout the AI lifecycle?', 'Legal, Governance, Regulatory and Ethical Considerations', 'organization'),

  // External Partnerships and Ecosystem (4 questions)
  createQuestion('org_partnerships_1', 'Are there partnerships in place to access external data sources or AI tools and technologies?', 'External Partnerships and Ecosystem', 'organization'),
  createQuestion('org_partnerships_2', 'Does the organization participate in industry collaborations, partnerships, or consortia to exchange knowledge, share best practices, and drive collective progress in AI adoption?', 'External Partnerships and Ecosystem', 'organization'),
  createQuestion('org_partnerships_3', 'Is the organization part of any AI ecosystems or industry consortia that facilitates knowledge sharing and collaboration?', 'External Partnerships and Ecosystem', 'organization'),
  createQuestion('org_partnerships_4', 'Does the organization have processes in place for selecting and managing AI vendors and suppliers?', 'External Partnerships and Ecosystem', 'organization'),

  // Implementation (4 questions)
  createQuestion('org_implementation_1', 'Are there integration challenges with existing systems or processes that need to be addressed for seamless AI adoption?', 'Implementation', 'organization'),
  createQuestion('org_implementation_2', 'Is there a governance framework in place to oversee AI initiatives and ensure alignment with organizational goals and values?', 'Implementation', 'organization'),
  createQuestion('org_implementation_3', 'Does the organization have processes in place to capture and document knowledge gained from AI initiatives, including lessons learned and best practices?', 'Implementation', 'organization'),
  createQuestion('org_implementation_4', 'Does the organization follow agile development practices for AI solutions?', 'Implementation', 'organization'),
...
export const industryBenchmarks = {
  'Technology': { 
    organization: 78, data: 82, business: 75, infrastructure: 85,
    average: 80, top25: 88, top10: 93
  },
  'Healthcare': { 
    organization: 65, data: 70, business: 68, infrastructure: 72,
    average: 69, top25: 78, top10: 85
  },
  'Financial Services': { 
    organization: 72, data: 78, business: 74, infrastructure: 80,
    average: 76, top25: 84, top10: 90
  },
  'Manufacturing': { 
    organization: 68, data: 65, business: 70, infrastructure: 75,
    average: 70, top25: 79, top10: 86
  },
  'Retail': { 
    organization: 70, data: 68, business: 78, infrastructure: 72,
    average: 72, top25: 81, top10: 87
  },
  'Education': { 
    organization: 62, data: 58, business: 65, infrastructure: 68,
    average: 63, top25: 72, top10: 80
  },
  'Government': { 
    organization: 58, data: 62, business: 60, infrastructure: 65,
    average: 61, top25: 70, top10: 78
  },
  'Other': { 
    organization: 65, data: 68, business: 70, infrastructure: 72,
    average: 69, top25: 78, top10: 84
  }
};
...
export function calculateAssessmentResults(data: AssessmentData): AssessmentResults {
  ...
  const pillarQuestions = {
    organization: assessmentQuestions.filter(q => q.pillar === 'organization'),
  ...
  console.log('Pillar questions count:', {
    organization: pillarQuestions.organization.length,
  ...
  const organizationScore = calculatePillarScore(pillarQuestions.organization, data.responses);
  ...
  const pillarScores: PillarScore[] = [
    {
      name: 'Organization',
      score: Math.round((organizationScore / 100) * pillarQuestions.organization.length * 5),
      maxScore: pillarQuestions.organization.length * 5,
      percentage: organizationScore,
      level: getPerformanceLevel(organizationScore),
      color: '#2563EB'
    },
    {
      name: 'Data',
  ...
  const overallPercentage = Math.round(
    (organizationScore + dataScore + businessScore + infrastructureScore) / 4
  );

  const overallScore = Math.round((overallPercentage / 100) * (pillarQuestions.organization.length + pillarQuestions.data.length + pillarQuestions.business.length + pillarQuestions.infrastructure.length) * 5);
...
function calculateIndustryPercentile(score: number, industry: string): number {
  ...
  const avgIndustryScore = (benchmark.organization + benchmark.data + benchmark.business + benchmark.infrastructure) / 4;
...
function generateRecommendations(pillarScores: { organization: number; data: number; business: number; infrastructure: number; }, data: AssessmentData): Recommendation[] {
  const recommendations: Recommendation[] = [];
  
  // Organization recommendations
  if (pillarScores.organization < 70) {
    recommendations.push({
      pillar: 'Organization',
      category: 'Strategy and Leadership',
      priority: 'High',
      title: 'Develop AI Strategy and Leadership',
      description: 'Establish a clear AI strategy with designated leadership and governance framework.',
      timeline: '3-6 months'
    });
  }
  ...
  if (pillarScores.business < 70) {
    recommendations.push({
      pillar: 'Business',
      category: 'Business Use Case and ROI',
      priority: 'High',
      title: 'Define AI Business Cases',
      description: 'Conduct ROI analysis and identify clear business use cases for AI initiatives.',
      timeline: '2-4 months'
    });
  }
  ...
  if (pillarScores.business < 60) {
    recommendations.push({
      ...
      priority: 'Medium',
      title: 'Start AI Pilot Projects',
      description: 'Launch pilot AI projects with clear success criteria and KPIs.',
      timeline: '3-6 months'
    });
  }
